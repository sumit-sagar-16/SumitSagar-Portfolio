...
const NavBar = () => {
  ...
  return (
    <div className="flex justify-between items-center bg-black w-full h-20 z-10 fixed px-4 text-white">
      ...
      <div
        onClick={() => setnav(!nav)}
        className="cursor-pointer md:hidden pr-4 z-10 text-gray-400"
      >
      ...
      {nav && (
            <ul className="flex flex-col justify-center items-center absolute top-0 left-0 w-full md:hidden h-screen bg-gradient-to-b from-black to-gray-800">
              ...
              <li className="flex gap-8 py-6">
                <a href=" https://www.linkedin.com/in/sumit-sagar-02a295141/"><FaLinkedin size={30} /></a>
                <a href=" https://github.com/sumit-sagar-16/"><FaGithub size={30}/></a>
                <a href=" mailto:sumitsagar16@gmail.com"><HiOutlineMail size={30}/></a>
              </li>
            </ul>
